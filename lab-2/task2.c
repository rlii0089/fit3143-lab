...
long count_local_candidates(long start_index,
                            long stride,
                            long end_index) {
    ...
    return
        ((end_index - start_index - 1) / stride)
        + 1;
}
 ...
 */
int find_local_primes_hybrid(long start_index,
                             long stride,
                             long end_index,
                             int thread_count,
    ...
    long local_candidate_count =
        count_local_candidates(
            start_index,
            stride,
            end_index
        );
